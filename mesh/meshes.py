"""OBJ validation, import, and eye split."""
import math
import os
import re
...
def check_paths(cfg: Config) -> list[str]:
    """Verify required OBJ files exist; return their paths. Raises FileNotFoundError if missing."""
...
def split_eyes(face_col: bpy.types.Collection, cfg: Config) -> tuple[bpy.types.Object, bpy.types.Object]:
    """Return (left_eye, right_eye). Common mode: split Eye Lens; separate mode: apply location/scale."""
